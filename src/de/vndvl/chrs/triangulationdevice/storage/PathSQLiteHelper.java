...
/**
 * A database-based storage helper class required by Android to interface with a
 * database. Handles database schema, creation, and upgrading.
 * 
 * OK, we don't do any legit upgrading. Please don't change the schema, oh god.
 */
public class PathSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String SESSIONS_CREATE = "create table " + TABLE_SESSIONS + "(" + COLUMN_SESSION_ID + " integer primary key autoincrement, " + COLUMN_SESSION_TITLE + " text not null, " + COLUMN_SESSION_TIME_SAVED + " text not null" + ");";
    ...
    private static final String PATHS_CREATE = "create table " + TABLE_PATHS + "(" + COLUMN_PATH_ID + " integer primary key autoincrement, " + COLUMN_PATH_SESSION_ID + " integer not null, " + COLUMN_PATH_TYPE + " integer not null" + ");";
